...
export default function Footer() {
  const { navigation, projects, experience, education, name, title, social, footer } = useTranslation();
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
          ...
          <div className="flex flex-col gap-4 items-center text-center md:items-start md:text-left">
            ...
            <div className="flex gap-4 text-gray-500 dark:text-gray-500">
              {social?.email && (
                <a href={`mailto:${social.email}`} aria-label={social.aria.email} className="hover:text-[var(--accent-color)] transition-colors duration-200 hover:scale-110">
              ...
              {social?.linkedin && (
                <a href={social.linkedin} target="_blank" rel="noopener noreferrer" aria-label={social.aria.linkedin} className="hover:text-[var(--accent-color)] transition-colors duration-200 hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
              ...
              {social?.github && (
                <a href={social.github} target="_blank" rel="noopener noreferrer" aria-label={social.aria.github} className="hover:text-[var(--accent-color)] transition-colors duration-200 hover:scale-110">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
          ...
          <div className="flex flex-col items-center text-center md:items-end gap-5">
            ...
            <p className="text-xs text-gray-400 dark:text-gray-600">
              © {year} {name}. {footer.copyright}
            </p>
            <p className="text-xs text-gray-400 dark:text-gray-700">
              {footer.builtWithLabel}{" "}
              <a href={footer.builtWithUrl} className="hover:text-gray-600 dark:hover:text-gray-500 transition-colors">
